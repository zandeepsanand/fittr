...
export default function HomeWorkoutCalender({formDataCopy, onDateChange,savedDate=[]}) {
  ...
  return (
    ...
    /> */}
      <CalendarStrip
        ...
        dateNameStyle={{color: 'black', marginTop: 5}}
        highlightDateNumberStyle={{color: 'black',marginTop: -5}}
        highlightDateNameStyle={{color: 'black', marginTop: 5}}
