...
export const ICONS: ThemeIcons = {
  ...
  fruit2: require('../assets/icons/fruit2.png'),
  fitness2: require('../assets/icons/fitness2.png'),
  salad: require('../assets/icons/salad.png'),
  book2: require('../assets/icons/book2.png'),
  stepone: require('../assets/icons/logo.png'),
  ...
  header3: require('../assets/images/header3.png'),
  header4: require('../assets/images/header4.png'),
  header5: require('../assets/images/header5.png'),
...
export const ASSETS: ThemeAssets = {
  ...
  card6: require('../assets/images/card6.jpg'),
  rocket: require('../assets/images/rocket.png'),
  greenbackground: require('../assets/images/background-green.png'),
  greeny: require('../assets/images/greeny.jpg'),
