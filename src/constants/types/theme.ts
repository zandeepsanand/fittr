...
export interface ThemeIcons {
  ...
  recommended: ImageSourcePropType;
}
...
export interface ThemeAssets {
  ...
  card6: ImageSourcePropType;
  rocket: ImageSourcePropType;
  greenbackground: ImageSourcePropType;
  greeny: ImageSourcePropType;
  green: ImageSourcePropType;
  dosa: ImageSourcePropType;
